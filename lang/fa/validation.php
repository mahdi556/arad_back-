...
return array(
    ...
    */
    'attributes' => array(
        ...
        'message' => 'متن پیام',
        'type' => 'نوع آگهی',
        'job_category_id' => 'دسته بندی شغلی',
        'data.title' => 'عنوان آگهی',
        'data.job_category_id' => 'نوع آگهی',
        'data.companyName' => 'نام شرکت',
        'data.companyId' => 'شناسه ملی شرکت',
        'data.name' => 'نام',
        'data.lastname' => 'نام خانوادگی',
        'data.Ename' => 'نام انگلیسی',
        'data.Elastname' => 'نام خانوادگی انگلیسی',
        'data.whatsapp' => 'شماره واتساپ',
        'data.telegram' => 'شماره تلگرام',
        'data.cellphone' => 'شماره تلفن همراه',
        'data.email' => 'ایمیل',
        'data.sex.id' => 'جنسیت',
        'data.city.id' => 'شهر',
        'data.province.id' => 'استان',
        'data.salary.fa.from' =>  'حداقل حقوق',
        'data.salary.fa.to' =>  'حداکثر حقوق',
